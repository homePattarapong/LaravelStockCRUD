                 ...
                 <div class="row">
                     <div class="col-md-10">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="product_barcode" name="product_barcode" placeholder="ป้อนบาร์โค้ด" value="{{$product->product_barcode}}" maxlength="5">
                          </div>
                     ...
                     <div class="col-md-2">
                        <div class="form-group">
                                ...
                                <img src="{{asset('upload/products/'.$product->product_image)}}" id="output" class="img-fluid rounded ">
                                @else
